...
class HPV_My_Clone_Army:
    '''
    Генерация ключей для игры My Clone Army в Hamster Kombat
    --------------------------------------------------------
    ...
    def __init__(self, Console_Lock: Lock, _Thread: int, Proxy: dict = None) -> None:
        self.APP_TOKEN = '74ee0b5b-775e-4bee-974f-63e7f4d5bacb'
        self.PROMO_ID = 'fe693b26-b342-4159-8808-15e3ff7f8767'
...
def _HPV_My_Clone_Army(Console_Lock, Retry, Proxy) -> dict:
    '''Генерация ключей для игры My Clone Army'''

    HPV_Keys = [] # Список хранящий ключи для My Clone Army
    Threads = [] # Список потоков

    def HPV_Key_Gen(_Thread, Proxy=None):
        HPV = HPV_My_Clone_Army(Console_Lock, f'{_Thread} Clone', Proxy)
        KEY = HPV.Run()
    ...
    return {'My Clone Army': HPV_Keys}, True if HPV_Keys else False